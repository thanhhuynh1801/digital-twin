...
class Aubo_kinematics():
    ...
    def aubo_forward(self,q):
        ...
        '''
        T[4] = C5 * C6 * S234 + C234 * S6
        T[5] = C234 * C6 - C5 * S234 * S6
        T[6] = S234 * S5
        T[7] = -C1 * (self.d2 + C5 * self.d6) - S1 * (self.a2 * S2 + (self.a3 + C4 * self.d5) * S23 + C23 * self.d5 * S4 - C234 * self.d6 * S5)

        T[8] = C234 * C5 * C6 * S1 + C1 * C6 * S5 - S1 * S234 * S6
        T[9] = -C6 * S1 * S234 - (C234 * C5 * S1 + C1 * S5) * S6
        T[10] = -C1 * C5 + C234 * S1 * S5
        T[11] = self.d1 + self.a2 * C2 + self.a3 * C23 + self.d5 * C234 + self.d6 * C2345/2 - self.d6 * C2345p / 2
        '''
...
if __name__=="__main__":
    ...
    for i in range(len(data)):
        ...
        if (i==0):
            ...
            joint_ref= joint
            TT=ak47.aubo_forward(ak47.rad_to_degree(joint))
            print('matran: ')
            print(TT)
            ...
            joint_ref=joint1
            TT=ak47.aubo_forward(ak47.rad_to_degree(joint1))
            print('matran: ')
            print(TT)
    ...
    # test dh
    qtest= [0.8289511,  -0.0274981 , -1.9919271 , 2.0194261 , 0.7418451 , -1.570796]
    TTT=ak47.aubo_forward(ak47.rad_to_degree(qtest))
    print(TTT)
